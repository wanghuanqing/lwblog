...
<body>
                    ...
                    <table class="list-table">
                        ...
                        <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                        <a href="<?php echo U('student/jobedit',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-small layui-btn-normal"><i class="layui-icon">&#xe642;</i></a>
    ...
    <script>
        function job_delete(obj) {
            ...
            //alert(id);
            $.ajax({
                url: '<?php echo U("student/job_delete");?>',
                type: "post",
                dataType: 'json',
                data: {
                    'id': id
