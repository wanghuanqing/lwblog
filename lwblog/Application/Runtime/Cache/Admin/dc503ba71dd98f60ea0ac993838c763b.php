              ...
              <textarea name="description" lay-verify="" autocomplete="off" placeholder="请输入栏目描述" class="layui-textarea"></textarea>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            ...
                            <button class="layui-btn" lay-submit="" lay-filter="feedback_edit" id="front_edit" type="button">修改</button>
    ...
    <script>
        $(function() {
            ...
            $('#front_edit').click(function() {
                ...
                var desc = $('#desc').val();
                $.ajax({
                    url: '<?php echo U("admin/front_edit");?>',
                    type: 'post',
                    dataType: 'json',
                    data: {
                        'title': title,
