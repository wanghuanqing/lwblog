...
<body>
                    ...
                    <table class="list-table">
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <a href="<?php echo U('admin/lostedit',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-small layui-btn-normal"><i class="layui-icon">&#xe642;</i></a>
    ...
    <script>
        function lost_delete(obj) {
            ...
            //alert(id);
            $.ajax({
                url: '<?php echo U("admin/lost_delete");?>',
                type: "post",
                dataType: 'json',
                data: {
                    'id': id
