...
<body>
    <div class="layui-tab layui-tab-brief main-tab-container">
        <ul class="layui-tab-title main-tab-title">
            ...
            <li class="layui-this">失物招领信息添加</li>

            <div class="main-tab-item">失物招领信息管理</div>
        </ul>
        <div class="layui-tab-content">
            <form class="layui-form" id="form" method="post" action="<?php echo U('admin/lost_add');?>">
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                              <!-- <textarea type="text/plain" id="content" name ="content" style="width:1000px;height:240px;"></textarea> -->
