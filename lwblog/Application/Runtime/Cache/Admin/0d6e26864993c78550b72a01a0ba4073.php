...
<body>
    <div class="layui-tab layui-tab-brief main-tab-container">
        ...
        <div style="padding:10px;">
            ...
            <ul class="layui-tab-title main-tab-title" id="classify">
                ...
                <li class="layui-this"> <a href="talklist.html">细语微言</a></li>
                    ...
                    <table class="list-table">
                        ...
                        <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                        <a href="<?php echo U('admin/talkedit',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-small layui-btn-normal"><i class="layui-icon">&#xe642;</i></a>
                                        <a onclick="talk_delete(this)" id="<?php echo ($vo["id"]); ?>" class="layui-btn layui-btn-small layui-btn-danger"><i class="layui-icon">&#xe640;</i></a>
    ...
    <script>
        function talk_delete(obj) {
            var id = obj.id;
            //alert(id);
            $.ajax({
                url: '<?php echo U("admin/talk_delete");?>',
                type: "post",
                dataType: 'json',
                data: {
                    'id': id
