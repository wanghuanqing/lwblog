...
<body>
    <div class="layui-tab layui-tab-brief main-tab-container">
        <ul class="layui-tab-title main-tab-title">
            <a href="lostlist.html">
                <li class="layui-this">失物招领信息列表</li>
            </a>
            <a href="lostadd.html">
                <li>失物招领信息添加</li>
            </a>

            <div class="main-tab-item">失物招领信息管理</div>
        </ul>
                    ...
                    <table class="list-table">
                        ...
                        <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                        <a href="<?php echo U('student/lostedit',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-small layui-btn-normal"><i class="layui-icon">&#xe642;</i></a>
                                        <a onclick="lost_delete(this)" id="<?php echo ($vo["id"]); ?>" class="layui-btn layui-btn-small layui-btn-danger"><i class="layui-icon">&#xe640;</i></a>
    ...
    <script>
        function lost_delete(obj) {
            ...
            //alert(id);
            $.ajax({
                url: '<?php echo U("student/lost_delete");?>',
                type: "post",
                dataType: 'json',
                data: {
                    'id': id
