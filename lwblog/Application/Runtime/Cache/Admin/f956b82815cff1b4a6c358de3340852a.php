...
<body>
                ...
                <div class="layui-tab-item layui-show">
                    <div class="layui-form-item"><label class="layui-form-label">用户名</label>
                        <div class="layui-input-inline input-custom-width">
                            <input id="name" type="text" name="name" value="<?php echo ($data["name"]); ?>" lay-verify="username" autocomplete="off" placeholder="请输入用户名" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item"><label class="layui-form-label">密码</label>
                        <div class="layui-input-inline input-custom-width">
                            <input id="password" type="password" name="password" value="<?php echo ($data["password"]); ?>" lay-verify="password" autocomplete="off" placeholder="请输密码" class="layui-input">
                        </div>
                    </div>
    ...
    <script src="/blog2/Public/admin/js/jquery-1.11.1.js"></script>
    <script>
        $(function() {
...
<body style="background:rgb(219, 207, 207)">
    ...
    <div class="login-item">
        <form action="<?php echo U('admin/loginadmin');?>" method="post">
            <div class="item">
                <label>账号:</label>
                <input value="<?php echo ($data["name"]); ?>" type="text" name="name" id="name" /><span id="messagename"></span>
            </div>
            <div class="item">
                <label>密码:</label>
                <input value="<?php echo ($data["password"]); ?>" type="password" name="password" id="password" /><span id="messagepassword"></span>
            </div>
            <!-- <div class="item">
                <label>验证码:</label>
