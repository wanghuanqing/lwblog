              ...
              <textarea name="description" lay-verify="" autocomplete="off" placeholder="请输入栏目描述" class="layui-textarea"></textarea>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            ...
                            <button class="layui-btn" lay-submit="" lay-filter="feedback_edit" id="lost_edit">立即修改</button>
    ...
    <script>
        $(function() {
            ...
            $('#lost_edit').click(function() {
                ...
                // alert(title, author, rtime, content, id, type);
                $.ajax({
                    url: '<?php echo U("student/lost_edit");?>',
                    type: 'post',
                    dataType: 'json',
                    data: {
                        'title': title,
