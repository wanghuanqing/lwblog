...
<body>
    <div class="layui-tab layui-tab-brief main-tab-container">
        ...
        <div class="layui-tab-content">
            <form class="layui-form" id="form" action="<?php echo U('admin/aboutblog_add');?>" method="post">
                <div class="layui-tab-item layui-show">
                    <div class="layui-form-item">
                        <label class="layui-form-label">标题</label>
                        <div class="layui-input-inline input-custom-width">
                            <input placeholder="0-20个字符" type="text" id="title" name="title" value="" lay-verify="required" autocomplete="off" placeholder="请输入标题" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline input-custom-width">
                            <input type="text" name="create_time" id="date" value="<?php echo ($data["date"]); ?>" ay-verify="datetime" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this,istime: 1, format: 'YYYY-MM-DD hh:mm:ss' })">
                        </div>
                    </div>
                    <div class="layui-form-item">
