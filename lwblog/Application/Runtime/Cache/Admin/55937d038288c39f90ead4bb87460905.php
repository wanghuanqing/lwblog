...
<body>
    <div class="layui-tab layui-tab-brief main-tab-container">
            <ul class="layui-tab-title main-tab-title">
                ...
                <div style="padding:10px;">
                    ...
                    <ul class="layui-tab-title main-tab-title">
                            <a href="bloglist.html"><li>博文列表</li></a>
                            <a href="bloglist.html"><li>胡思乱想</li></a>
                            <a href=""><li>细语微言</li></a>
                            <a href=""><li>前端入坑</li></a>
                            <a href="swaplist.html"><li class="layui-this">后端崛起</li></a>
                        </ul>
                </div>
    ...
    <script>
        function swap_delete(obj) {
            ...
            //alert(id);
            $.ajax({
                url: '<?php echo U("admin/swap_delete");?>',
                type: "post",
                dataType: 'json',
                data: {
                    'id': id
