...
<head>
    ...
    <!-- 比较好用的代码着色插件 -->
    <link href="/blog2/Public/home/css/prettify.css" rel="stylesheet" />
    <!-- 本页样式表 -->
    <link href="/blog2/Public/home/css/detail.css" rel="stylesheet" />
</head>
<body>
    <!-- 导航 -->
...
pagesize(laypageId, pageSize).callback(function (newPageSize) {
    ...
    <!-- 比较好用的代码着色插件 -->
    <script src="/blog2/Public/home/js/prettify.js"></script>
    <!-- 本页脚本 -->
    <script src="/blog2/Public/home/js/detail.js"></script>
</body>
</html>