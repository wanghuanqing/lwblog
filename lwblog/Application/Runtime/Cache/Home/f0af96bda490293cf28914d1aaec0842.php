        ...
        <div class="page_left">
            ...
            <div class="detail_container trans_3">
                ...
                <div class="aboutinfo">
                    ...
                    <p class="aboutinfo-nickname">老王博客</p>
                    <p class="aboutinfo-introduce">一个web、php程序员的个人博客，记录博主学习和成长之路，分享技术和源码</p>
                    <p class="aboutinfo-location"><i class="fa fa-link"></i>&nbsp;&nbsp;<a target="_blank" href="http://www.lwblog.com">www.lwblog.com</a></p>
                    <hr />

                    <fieldset class="layui-elem-field layui-field-title">
                        <legend>简介</legend>
                        <div class="layui-field-box aboutinfo-abstract">
                            <p style="text-align:center;">老王博客是一个由php、web前端、layui开发的个人博客网站，诞生于2017年10月7日，起劲为止经历了一次大改，暂且称为老王博客2.0。</p>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><li>
                                    <hr />
                                    <h1><?php echo ($vo["title"]); ?></h1>
                                    <p id="p"><?php echo (htmlspecialchars_decode($vo["content"])); ?></p>
