...
<body>
    ...
    <div class="main breadcrumb_nav trans_3">
	  ...
	  <a href="<?php echo U('home/index');?>">首页</a><cite></cite><a href="<?php echo U('home/article_list');?>">文章栏目</a></cite> <a><cite>胡思乱想</cite></a>
	</span>
    </div>
    <!-- 面包屑导航 结束 -->
    <!-- 文章 开始 -->
    <div class="main">
        <div class="page_left">
            ...
            <ul class="page_left_list">
                <?php if(is_array($listthink)): foreach($listthink as $key=>$vo): ?><li id="lists ">
