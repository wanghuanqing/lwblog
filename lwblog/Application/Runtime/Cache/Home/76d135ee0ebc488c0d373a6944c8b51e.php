...
<head>老王博客
    ...
    <link href="/lwblog/Public/home/images/laowang.jpg" rel="shortcut icon" type="image/x-icon">
...
<body>
    ...
    <div class="main breadcrumb_nav trans_3">
	  ...
	  <a href="./index.html">首页</a><a><cite>文章栏目</cite></a>
	</span>
    </div>
    <!-- 面包屑导航 结束 -->
    <!-- 文章 开始 -->
    <div class="main">
        <div class="page_left">
            <ul class="page_left_list">
                <?php if(is_array($listsearch)): foreach($listsearch as $key=>$vo): ?><li id="lists ">
