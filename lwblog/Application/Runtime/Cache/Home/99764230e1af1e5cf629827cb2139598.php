...
<body>
    ...
    <div class="main breadcrumb_nav trans_3">
	  ...
	  <a href="<?php echo U('home/index');?>">首页</a><cite></cite><a href="<?php echo U('home/article_front');?>">文章栏目</a></cite> <a><cite>前端入坑</cite></a>
	</span>
    </div>
    <!-- 面包屑导航 结束 -->
    <!-- 文章 开始 -->
    <div class="main">
        <div class="page_left">
            ...
            <ul id="NO2" class="page_left_list">
                <?php if(is_array($listfront)): foreach($listfront as $key=>$vo): ?><li>
