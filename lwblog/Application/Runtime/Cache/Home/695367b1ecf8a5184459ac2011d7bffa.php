...
<body>
    ...
    <div class="main breadcrumb_nav trans_3">
		...
		<a href="<?php echo U('home/index');?>">首页</a><cite></cite><a href="<?php echo U('home/article_home');?>">文章栏目</a></cite> <a><cite>后端崛起</cite></a>
    ...
    <div class="main">
        <div class="page_left">
            ...
            <ul id="NO2" class="page_left_list">
                <?php if(is_array($listhome)): foreach($listhome as $key=>$vo): ?><li>
