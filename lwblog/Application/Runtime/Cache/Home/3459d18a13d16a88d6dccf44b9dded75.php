    ...
    <div class="main layui-clear">
        <div class="wrap">
          ...
          <a href="main.html">我的发布</a>
                    ...
                    <a href="<?php echo U('home/addswap');?>" class="layui-btn jie-add">发布旧物交换</a>
                </div>
                    ...
                    <tbody class="fly-list fly-list-top">
                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="fly-list-li" style="width:500px;height: 65px;">
                                <td style="padding-left:30px;">
                                    ...
                                    <h2 class="fly-tip">
                                        <a href="<?php echo U('home/detail_swap',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
                                    </h2>
                                    <p>
